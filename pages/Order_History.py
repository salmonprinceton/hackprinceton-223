...
ethan = ds.User(1, "", "ep0148@princeton.edu", password = "curiousSalmon2", false)
satan = ds.User(2, "Satan", "satan666@hell.com", password = "IHATEGOD666", false)
impostor = ds.User(3, "Red Impostor", "reallyred@sussybaka.net", password = "YOUARESUS", false)
...
delivery_list = [Delivery("Processed", "", order_list[i]) for i in range(0, len(user_list))]
